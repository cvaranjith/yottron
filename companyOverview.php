...
<!-- Mirrored from html.gptheme.com/astriol/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Nov 2023 14:42:18 GMT -->
<head>
	<!-- Meta Data -->
	<meta charset="utf-8">
...
<body id="home-version-1" class="about-page-template" data-style="default">
	...
	<div id="main_content" class="main-content">
		...
		<section class="feature-agency-about">
			<div class="bg-shape">
				<img src="media/background/3.png" alt="astriol shape bg">
			</div>
			<!-- /.bg-shape -->
			...
			<div class="container">
				<div class="section-heading style-two color-theme">
					...
					<h2 class="section-title">Best Solutions for You</h2>
				</div>
					...
					<div class="col-md-4">
						<div class="icon-box style-three">
							...
							<div class="box-content">
								...
								<p>
									Tosser car boot ummm I'm telling hanky panky blower brown bread horse play boot starkers.!
								</p>
								<a href="#" class="gp-btn btn-outline">Learn More</a>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="fun-fact color--one wow fadeInUp" data-wow-delay="0.3s">
								...
								<!-- /.icon-box -->
								<h4 class="count" data-counter="44780">4478 </h4>
								<p class="count-name">Happy Client</p>
							</div>
							<!-- /.fun-fact -->
						</div>
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="fun-fact color--two wow fadeInUp" data-wow-delay="0.5s">
								...
								<p class="count-name">Completed Projects</p>
							</div>
							<!-- /.fun-fact -->
						</div>
						<!-- /.col-lg-3 col-md-6 col-sm-6 -->
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="fun-fact color--three wow fadeInUp" data-wow-delay="0.7s">
								...
								<!-- /.icon-box -->
								<h4 class="count" data-counter="23">5 </h4>
								<p class="count-name">Years of Service</p>
							</div>
							<!-- /.fun-fact -->
						</div>
						<!-- /.col-lg-3 col-md-6 col-sm-6 -->
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="fun-fact color--four wow fadeInUp" data-wow-delay="0.9s">
								...
								<!-- /.icon-box -->
								<h4 class="count" data-counter="6264">626 </h4>
								<p class="count-name">People Consulted</p>
							</div>
							<!-- /.fun-fact -->
						</div>
						<!-- /.col-lg-3 col-md-6 col-sm-6 -->
						...
						<div class="about-feature-image">
							<div class="top-content bg-gradient-two wow fadeInLeft">
								...
								<h3 class="ab-subtitle">
									Yottron<br> Solutions
								</h3>
							</div>
							<div class="image-wrapper wow fadeInRight">
								<img src="assets/img/about.jpg" alt="astriol about">
							</div>
						</div>
					</div>
					<!-- /.col-md-6 -->
					<div class="col-md-6">
						<div class="about-content-wrapper ">
							<h2 class="about-title wow fadeInUp">
								Welcome to our Business <br> Yottron Solutions
							</h2>
							<p class="wow fadeInUp" data-wow-delay="0.3s">
								Harry I nice one I don't want no agro such a fibber daft pukka some dodgy chav cheeky bugger cheers A bit of how's your father say at public school, chip shop bleeder barney I no biggie hanky panky cras absolutely.!
							</p>
...
<!-- Mirrored from html.gptheme.com/astriol/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Nov 2023 14:42:21 GMT -->
</html>